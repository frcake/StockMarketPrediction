function [Xps_train,Xps_test,Tps_train,Tps_test] = generate_training_testing_data(Xps,Tps,training_percentage,validation_percentage)
...
Tps_test = Tps(cutoff+1:(Nps-test_barrier));
Xps_train = Xps(1:cutoff,:);
Xps_test = Xps(cutoff+1:(Nps-test_barrier),:);
